...
Compilacion: 
		g++ -std=c++11 ITV_tiempos.cpp -o ejecutable
...
void TiempoEjecucion(int numCoches,clock_t t_despues,clock_t t_antes){
	...
	cout<< numCoches<< "\t" << ((double)(t_despues - t_antes)) / CLOCKS_PER_SEC  << endl;   //Se restan el tiempo de despues menos el de antes para saber la diferencia
