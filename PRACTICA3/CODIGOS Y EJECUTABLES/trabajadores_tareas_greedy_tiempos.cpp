...
*/
void tiempo_total(clock_t tiempo2, clock_t tiempo1, int mayor_fila_columna);
...
void tiempo_total(clock_t tiempo2, clock_t tiempo1, int mayor_fila_columna ){
    ...
    cout<< mayor_fila_columna <<"  " << (double)tiempo_total/1000   << endl;
...
int main(int argc, char * argv[]){
	...
	tiempo_total(tiempo2, tiempo1, mayor_fila_columna);   						
